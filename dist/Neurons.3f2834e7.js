...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"app/Neurons.js":[function(require,module,exports) {
var neurons = document.querySelector('neurons');
neurons.width = window.innerWidth;
neurons.height = window.innerHeight;
var ctx = neurons.getContext('2d');
var particules = [];
var configuration = {
...
var render = function render() {
  ...
  particules.forEach(function (particule) {
    var x = particule.x + particule.speedX;
    var y = particule.y + particule.speedY;
    if (x <= 0 || x >= window.innerWidth) particule.speedX *= -1;
    if (y <= 0 || y >= window.innerHeight) particule.speedY *= -1;
    particule.x = x;
    particule.y = y;
    var mouseDx = mouseX - particule.x;
    var mouseDy = mouseY - particule.y;
    var mouseD = Math.sqrt(mouseDx * mouseDx + mouseDy * mouseDy);

    if (mouseD <= configuration.mouseSpace && false) {
      if (!particule.isColliding) {
        var angle = Math.atan2(particule.y - mouseY, particule.y - mouseY);
    ...
    ctx.fill();
    particules.forEach(function (nextParticule) {
      var dx = particule.x - nextParticule.x;
      var dy = particule.y - nextParticule.y;
...
var createParticules = function createParticules() {
  return new Promise(function (resolve) {
    for (var i = 0; i < configuration.numberParticules; i++) {
      var particule = {
...
createParticules().then(function () {
  render();
});
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/Neurons.js"], null)
//# sourceMappingURL=/Neurons.3f2834e7.js.map